...
$act=$_GET[PHPIdSession];
    $id= $_REQUEST['identitas'];
    $kode= $_REQUEST['jurusan'];
    $idp= $_REQUEST['program'];
    $tahun= $_REQUEST['tahun'];
if ($page=='jadkulAkd' AND $act=='insertjdwl'){
 ...
 header('location:../media.php?page=jadkulAkd&ID='.$id.'&codd='.$kode.'&prog='.$idp.'&tahun='.$tahun);
}

elseif ($page=='jadkulAkd' AND $act=='updatejadkul'){
    $id=$_POST['identitas'];
    $kode=$_POST['codd'];
    $idpr=$_POST['program'];
    $tahun=$_POST['tahun'];
 ...
 header('location:../media.php?page=jadkulAkd&ID='.$id.'&codd='.$kode.'&prog='.$idpr.'&tahun='.$tahun);
}

elseif ($page=='jadkulAkd' AND $act=='updatejadujianuts'){
    $id=$_POST['identitas'];
    $kode=$_POST['codd'];
    $idpr=$_POST['program'];
    $tahun=$_POST['tahun'];
...
elseif ($page=='jadkulAkd' AND $act=='updatejadujianuas'){
    $id=$_POST['identitas'];
    $kode=$_POST['codd'];
    $idpr=$_POST['program'];
    $tahun=$_POST['tahun'];
...
elseif ($page=='jadkulAkd' AND $act=='hapusjadwl'){
    $id=$_POST['identitas'];
    $kode=$_POST['jurusan'];
    $idpr=$_POST['program'];
    $tahun=$_POST['tahun'];
