...
switch($_GET[PHPIdSession]){
  ...
  default:
        ...
        ?>   
            <tr>
              <td class="cc">Institusi</td>   <td colspan=2 class="cb"> : <select name="institusi" onChange="MM_jumpMenu('parent',this,0)">
                <option value="?page=jadkulAkd">- Pilih Institusi -</option>
            <?php
            ...
            if ($d['Identitas_ID']==$id){
              ...
              echo "<option value='?page=jadkulAkd&ID=$d[Identitas_ID]' $cek> $d[Identitas_ID] - $d[Nama_Identitas]</option>";
        		}
        		?>
              </select>
              <input name="identitas" type="hidden" value="<?= $id; ?>"></td>
            </tr>
            <tr>
              <td class="cc">Jurusan</td>   <td colspan=2 class="cb"> : <select name="jurusan" onChange="MM_jumpMenu('parent',this,0)">
                <option value="media.php?page=jadkulAkd">- Pilih Jurusan -</option>
            <?php
            ...
            if ($d1['kode_jurusan']==$kode){
              ...
              echo "<option value='?page=jadkulAkd&ID=$id&codd=$d1[kode_jurusan]' $cek> $d1[kode_jurusan] - $d1[nama_jurusan]</option>";
        		}
        		?>
              </select>
            ...
            if ($d2['ID']==$idp){
              ...
              echo "<option value='?page=jadkulAkd&ID=$id&codd=$kode&prog=$d2[ID]' $cek> $d2[Program_ID] - $d2[nama_program]</option>";
        		}
        		?>
              </select>
            ...
            <tr>
              <td class="cc">Tahun Akademik</td>   <td colspan=2 class="cb"> : <select name="tahun" onChange="MM_jumpMenu('parent',this,0)">
                <option value="media.php?page=jadkulAkd">- Tahun -</option>
            <?php
            ...
            if ($d2['ID']==$tahun){
              ...
              echo "<option value='?page=jadkulAkd&ID=$id&codd=$kode&prog=$idp&tahun=$d2[ID]' $cek> $d2[Tahun_ID] </option>";
        		}
        		?>
              </select>
            ...
            <?php
            echo"
            <tr><td class=cc>Pilihan</td>    <td colspan=2 class=cb>  <a class=s href=media.php?page=jadkulAkd&PHPIdSession=addjadkul><img src=../img/tambah.png> Tambah Jadwal |</a>
          ...
          $sql="SELECT * FROM view_jadwal WHERE Identitas_ID='$id' AND Kode_Jurusan='$kode' AND Program_ID='$idp' AND Hari='Senin' AND Tahun_ID='$tahun' GROUP BY Jadwal_ID";
        	...
        	$no++;
             echo "<tr bgcolor=$warna>                            
                   <td><a class=s href='?page=jadkulAkd&PHPIdSession=editjadwalmtk&ID=$id&codd=$kode&prog=$idp&tahun=$tahun&gis=$r[Jadwal_ID]'>$r[Jadwal_ID] <img src=../img/edit.png></a></td>
                   <td><a class=s href='?page=jadkulAkd&PHPIdSession=editjadwalujian&ID=$id&codd=$kode&prog=$idp&tahun=$tahun&gis=$r[Jadwal_ID]'> <img src=../img/edit_2.png></a></td>
      		         ...
      		         <td>$r[Kelas]</td>
       		         ...
       		         <td>$r[Aktif]</td>
                   <td><a class=s href='akademik/akademikjadkulact.php?page=jadkulAkd&PHPIdSession=hapusjadwl&gos=$r[Jadwal_ID]'><img src=../img/del.gif></a></td>                    
                    </tr>";        
                  }
                  echo"</table>";
  ...
  case "addjadkul":
    ...
    <?
       echo"<div id=headermodul>Tambah Jadwal Kuliah</div>            
            <div id=groupmodul1>
            <table id=tablemodul><form method=post  action=akademik/akademikjadkulact.php?page=jadkulAkd&PHPIdSession=insertjdwl>
    ...
    ?>   
    <tr>
      <td class="cc">Institusi *</td>   <td colspan=2 class="cb">  <select name="identitas" onChange="MM_jumpMenu('parent',this,0)">
        <option value="media.php?page=jadkulAkd">- Pilih Institusi -</option>
    <?php
	  $sqlp="SELECT * FROM identitas ORDER BY Identitas_ID";
	  $qryp=mysql_query($sqlp)
	  or die();
    ...
    if ($d['Identitas_ID']==$id){
      ...
      echo "<option value='?page=jadkulAkd&PHPIdSession=addjadkul&ID=$d[Identitas_ID]' $cek> $d[Identitas_ID] - $d[Nama_Identitas]</option>";
		}
		?>
      </select>
      <input name="identitas" type="hidden" value="<?= $id; ?>"></td>
    ...
    if ($d1['kode_jurusan']==$kode){
      ...
      echo "<option value='?page=jadkulAkd&PHPIdSession=addjadkul&ID=$id&codd=$d1[kode_jurusan]' $cek> $d1[kode_jurusan] - $d1[nama_jurusan]</option>";
		}
		?>
      </select>
      <input name="jurusan" type="hidden" value="<?= $kode; ?>"></td>
    ...
    if ($d2['ID']==$idp){
      ...
      echo "<option value='?page=jadkulAkd&PHPIdSession=addjadkul&ID=$id&codd=$kode&prog=$d2[ID]' $cek> $d2[Program_ID] - $d2[nama_program]</option>";
		}
		?>
      </select>
      <input name="program" type="hidden" value="<?= $idp; ?>"></td>
  ...
  $tahun= $_GET['tahun'];
    ...
    $ed=mysql_fetch_array($edit);
     ...
     echo"<div id=headermodul>Edit Jadwal Kuliah</div>            
          <div id=groupmodul1>
          <table id=tablemodul>       
    <form method=post  action=akademik/akademikjadkulact.php?page=jadkulAkd&PHPIdSession=updatejadkul>     
    ...
    <tr><td class=cc>Pilihan </td> <td colspan=2 class=cb> : <a class=s href=?page=jadkulAkd&ID=$id&codd=$kode&prog=$idp&tahun=$tahun><img src=../img/back.png> Kembali Ke Jadwal |</a></tr></td>
  ...
  $tahun= $_GET['tahun'];
    ...
    $ed=mysql_fetch_array($edit);
     ...
     echo"<div id=headermodul>Edit Jadwal Ujian</div>            
          ...
          <div id=groupmodul>
          <form method=post  action=akademik/akademikjadkulact.php?page=jadkulAkd&PHPIdSession=updatejadujianuts>
          <table id=tablemodul>
     ...
     echo"<div id=groupmodul1>
          <form method=post  action=akademik/akademikjadkulact.php?page=jadkulAkd&PHPIdSession=updatejadujianuas>
          <table id=tablemodul>
          <input type=hidden name=id value=$ed[Jadwal_ID]>
           <input type=hidden name=identitas value=$id>
          <input type=hidden name=codd value=$kode>
