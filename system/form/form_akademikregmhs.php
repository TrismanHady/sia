...
switch($_GET[PHPIdSession]){
  ...
  default:
    echo"<div id=headermodul>Registrasi Ulang Mahasiswa</div>
           <form method=post  action='?page=registrasimahasiswa&PHPIdSession=CariMahasiswa'>
  ...
  echo"   <table id=tablemodul>
            <tr><th>No</th><th>Tahun Akd</th><th>Tanggal Reg</th><th>Aktif</th><th>Registrasi</th><th>Hapus</th></tr>";
              $sql="SELECT * FROM tahun t1 WHERE t1.Tahun_ID='$_POST[tahun]' AND Jurusan_ID='$data1[kode_jurusan]' AND Program_ID='$data1[ID]' AND t1.Aktif='Y'";
              $no=0;
              $qry=mysql_query($sql)
              or die ();
              ...
              $no++;
                ...
                echo"<form name=form1 method=post  action='?page=registrasimahasiswa&PHPIdSession=InputRegMhs'>
                ...
                <td align=center><a href='?page=registrasimahasiswa&PHPIdSession=delregmhs&gos=$d[ID_Reg]'><img src=../img/del.GIF></a></td>";                      
              }  
  ...
  echo"<table id=tablemodul>
          ...
          echo" </td>
                <td align=center bgcolor=$bg>$Aktif</td>
                <td align=center bgcolor=$bg ><input type=submit value=Registrasi $disable ></td>
                <td align=center><a href='?page=registrasimahasiswa&PHPIdSession=delregmhs&gos=$d[ID_Reg]'><img src=../img/del.GIF></a></td></tr>
              </table></form></div>";
          } 
  break;  
